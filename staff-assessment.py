            ...
            <div class="user-details">
              ...
              <div class="select-box">
                ...
                <select id="web" name="course1">
                  <option>Select</option>
                  <option value="blockchain">Professional Certificate Program in Blockchain</option>
                  <option value="DevOps">Post Graduate Program in DevOps</option>
                  <option value="cybersecurity">Professional Certificate Program in Cybersecurity- Red Team</option>
                  <option value="pg AI">Post Graduate Program in AI and Machine Learning</option>
                  <option value="pg cybersecurity">Post Graduate Program in Cyber Security</option>
                  <option value="AI & ML">Professional Certificate Course in AI and Machine Learning</option>
              </select>
              ...
              <div class="select-box">
                <span class="details">Assessment Month</span>
              ...
              <div class="input-box">
                <span class="details">Assessment Date</span>
                <input type="date"  name="adate" required>
              </div>
              <div class="select-box">
                <span class="details">Performance Level</span>
...
pdate = f.getvalue("adate")
pperformance = f.getvalue("performance")
premark = f.getvalue("remark")
psub = f.getvalue("sub")

pcourse = f.getvalue("course1") if pdept == "webdesign" else f.getvalue("course2") if pdept == "seo" else f.getvalue(
    "course3") if pdept == "Programming Language" else ""

if psub != None:
    cur.execute("""insert into assessment(EID, Name, Department, Course, AssessmentMonth, AssessmentDate, Performance, 	Remark) values
        ('%s','%s','%s','%s','%s','%s','%s','%s')""" % (peid, pname, pdept, pcourse, pmonth, pdate, pperformance, premark))
    connection.commit()
    print("""
        <script>
                alert("Success");
