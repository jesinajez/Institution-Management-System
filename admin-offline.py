...
<!DOCTYPE html>
    ...
    <div class="containersss">
      <div class="container1">
        <div class="title">Students for offline classes</div>
        <div class="content">
          <form action="#" method="post">
            <div class="user-details">
              ...
              <div class="input-box">
                <span class="details">Class Mode</span>
                <input type="text" placeholder="Offline" value="Offline" name="cmode" readonly>
              </div>
              ...
              <div class="select-box">
                ...
                <select id="mode" name="mode">
                  <option>Select</option>
                  <option value="Hostel">Yes</option>
                  <option value="Day Scholar">No</option>
              </select>
              </div>
              <div class="input-box">
              ...
              <div class="select-box">
                ...
                <select id="payment" name="payment">
                  <option>Select</option>
                  <option value="online">Online(Full Payment Required)</option>
...
pduration = f.getvalue("duration")
pmode = f.getvalue("mode")
pfees = f.getvalue("fees")
ppayment = f.getvalue("payment")
psub = f.getvalue("sub")
...
if psub != None:
        cur.execute("""insert into student(EID, Class_Mode, Department, Course, Duration, Mode, Fees, Payment_Method) values
        ('%s','%s','%s','%s','%s','%s','%s','%s')""" % (peid, pcmode, pdept, pcourse, pduration, pmode, pfees, ppayment))
        connection.commit()
        print("""
        <script>
            alert("Success");
