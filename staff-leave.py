...
a = """select Name from staff where EID='%s'"""%(peid)
cur.execute(a)
f = cur.fetchone()
...
print("""
    ...
    <div class="containersss">
      <div class="container1">
        <div class="title">Staff Leave Form</div>
        <div class="content">
...
print(f"""
              <div class="input-box">
                ...
                <input type="text"  value="{peid}" name="eid" readonly>
              </div>
              <div class="input-box">
                <span class="details">Name</span>
                <input type="text"  name="sname" value="{f[0]}" readonly>
              </div>
            """)
print("""
              <div class="date-box">
                <span class="details">From</span>
                <input type="date" name="fromd" required>
              </div>
              <div class="date-box">
                <span class="details">To</span>
                <input type="date" name="tod" required>
              </div>
              <div class="text-box">
...
pfrom = f.getvalue("fromd")
pto = f.getvalue("tod")
preason = f.getvalue("reason")
psub = f.getvalue("sub")
if psub != None:
    q = """INSERT INTO applyleave(EID, Name, Type, From_Date, To_Date, Reason, Status) 
            VALUES(%s, %s, %s, %s, %s, %s, %s)"""
    values = (pid, pname, "Staff", pfrom, pto, preason, "Pending")
