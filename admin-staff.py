        ...
        <div class="content">
          <form action="#" method="post">
            ...
            <div class="input-box">
                ...
                <input type="text"  name="eid" value={aid} >
              </div>
              <div class="input-box">
                <span class="details">Section</span>
                <input type="text" value="Office Staff" name="Office Staff" readonly>
              </div>
              <div class="input-box">
              ...
              <div class="select-box">
                ...
                <select id="qual" name="qual">
                  ...
                  <option value="Bachlor Degree">Bachlor Degree</option>
        ...
        if ppwd == pcpwd:
                cur.execute("""insert into staff(EID, Section, Name, Qualification, DOB, Phone, Email, Password, Place, Department, Salary) values(
                       '%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')""" %
                            (peid, psection, pname, pqual, pdob, ppno, pmail, ppwd, pplace, pdept, psalary))
